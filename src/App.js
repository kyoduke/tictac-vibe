...
function App() {
  ...
  return (
    <motion.div
      className="flex flex-col items-center justify-center min-h-screen p-8 gap-8 bg-background"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 0.5 }}
    >
      <h1 className="text-primary text-5xl text-center mb-4 font-sans font-bold">
        Tic Tac Toe
      </h1>

      <motion.div
        className="flex flex-col items-center bg-white p-8 rounded-xl shadow-lg max-w-[90vw]"
      ...
      <footer className="mt-8 text-center text-text text-sm">
