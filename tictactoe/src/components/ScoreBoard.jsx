  ...
  return (
    ...
    >
      <div className="grid grid-cols-3 gap-2 sm:gap-3 md:gap-4 w-full mt-2 sm:mt-3 md:mt-4">
        ...
        >
          <p className="text-xs sm:text-sm md:text-base font-medium mb-1 sm:mb-2 text-primary">
            Player X
          </p>
        ...
        >
          <p className="text-xs sm:text-sm md:text-base font-medium mb-1 sm:mb-2 text-text">
            Ties
          </p>
          <p className="text-lg sm:text-xl md:text-2xl font-bold text-text">
            {scores.ties}
        ...
        <div className="relative">
          ...
          >
            <p className="text-xs sm:text-sm md:text-base font-medium mb-1 sm:mb-2 text-secondary">
      ...
      <span className="text-xs sm:text-sm md:text-base text-text">
        Current Turn:
      </span>
      <motion.div
      ...
      >
        <span
          className={`font-bold text-sm sm:text-base md:text-lg ${currentPlayer === "X" ? "text-primary" : "text-secondary"}`}
        >
          {currentPlayer}
